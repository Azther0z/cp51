...
pg.mixer.init()
pg.mixer.music.load(ASSET_DIR / "sound.mp3")
pg.mixer.music.play(-1, 0.0)

# ใช้คำสั่ง soundeffect.play() เพื่อเล่นเสียง effect ตอนลูกบอลชนกัน
soundeffect = pg.mixer.Sound(ASSET_DIR / "effect.wav")
...
ball1_img = pg.image.load(ASSET_DIR / "BNK48" / "Wee_cc.png").convert_alpha()
ball1_img = pg.transform.scale(ball1_img, (150, 150))
ball1_rect = ball1_img.get_rect(center=(500,250))

ball2_img = pg.image.load(ASSET_DIR / "BNK48" / "Cherprang_cc.png").convert_alpha()
ball2_img = pg.transform.scale(ball2_img, (100, 100))
ball2_rect = ball2_img.get_rect(center=(250,120))

ball3_img = pg.image.load(ASSET_DIR / "BNK48" / "Eve_cc.png").convert_alpha()
