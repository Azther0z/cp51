...
class Ship(pg.sprite.Sprite):
    def __init__(self,color, width, height):
        ...
        self.image=pg.image.load(ASSET_DIR / "img" / "Ship.png")
...
# โดยกำหนด attribute .image ไปยัง "../assets/img/meteor_med.png" 
...
class Meteor(pg.sprite.Sprite):
    def __init__(self,width, height):
        ...
        self.image = pg.Surface([30, 40])
        self.image=pg.image.load(ASSET_DIR / "img" / "meteor_med.png")
        self.image= pg.transform.scale(self.image,(width,height))
...
shipGroup=pg.sprite.Group()
shipGroup.add(myShip)
...
while True:
    ...
    pg.sprite.spritecollide(myShip,meteorGroup,True)
