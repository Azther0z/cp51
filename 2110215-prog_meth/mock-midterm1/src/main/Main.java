...
//        network.save("saved_weights.txt");
        ...
        Network.load("saved_weights.txt");
        Scanner scanner = new Scanner(System.in);
        System.out.print("Input filename from image folder: ");
        String line = scanner.nextLine().trim();
        String imageFileName = line + ".jpg";

        double[] sample = ImageProcessor.process(imageFileName);
