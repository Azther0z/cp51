...
public class TestDamageSpellCard {
	...
	@Test
	void testSetDamage() {
		spell1.setDamage(900);
		assertEquals(spell1.getDamage(), 900);
		spell1.setDamage(0);
		assertEquals(spell1.getDamage(), 1);
		spell1.setDamage(-10);
		assertEquals(spell1.getDamage(), 1);
	}
	@Test
	void testCastSpell() {
		...
		assertEquals(unit.getHealth(), 9);
		// 9-2=7
		spell2.castSpell(unit);
		assertEquals(unit.getHealth(), 7);
		// 7-3=4
		spell3.castSpell(unit);
		assertEquals(unit.getHealth(), 4);
		// 4-1=3
		spellN.castSpell(unit);
		assertEquals(unit.getHealth(), 3);
		spell1.setDamage(900);
