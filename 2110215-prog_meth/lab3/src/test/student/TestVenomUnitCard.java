...
public class TestVenomUnitCard {
	...
	// Fill Code Here!!!
	// 1.testAttack (Must test with all 3 venomUnit on oppoUnit1 with higher than 0
	// health, you can use .setHealth(int))
	@Test
	void testAttack() {
		// 100
		int damage1 = venomUnit1.attackUnit(oppoUnit1);
		assertEquals(0, oppoUnit1.getHealth());
		assertEquals(damage1, 100);
		// 150
		oppoUnit1.setHealth(150);
		int damage2 = venomUnit2.attackUnit(oppoUnit1);
		assertEquals(0, oppoUnit1.getHealth());
		assertEquals(damage2, 150);
		// 200
		oppoUnit1.setHealth(200);
		int damage3 = venomUnit3.attackUnit(oppoUnit1);
		assertEquals(0, oppoUnit1.getHealth());
		assertEquals(damage3, 200);
