...
class list
{
  ...
  public:
    ...
    //----------------- iterator ---------------
    iterator begin() {
      return iterator(mHeader->get_next());
    }
    ...
    //----------------- access -----------------
    T& front() { return mHeader->get_next()->data; }

    T& back() { return mHeader->get_prev()->data; }
    ...
    void pop_back() {
      erase(iterator(mHeader->get_prev()));
    }
    ...
    void print() {
      ...
      for (iterator it = begin(); it != end(); it++) {
        ...
        std::cout << "prev data: "<< it.ptr->get_prev()->data << " ";
        std::cout << "next data: " << it.ptr->get_next()->data << std::endl;
      }
      std::cout << "-----------------" << std::endl;
    }
    ...
    void print_with_nextnext() {
      ...
      for (iterator it = begin(); it != end(); it++) {
        std::cout << "cur data: " << *it << " ";
        std::cout << "prev data: "<< it.ptr->get_prev()->data << " ";
        std::cout << "next data: " << it.ptr->get_next()->data << " ";
        std::cout << "nextnext data: ";
        if (it.ptr->get_nextnext() == nullptr) {
          std::cout << "nullptr";
        } else {
          std::cout << it.ptr->get_nextnext()->data;
        }
        std::cout << std::endl;
      }
      std::cout << "-----------------" << std::endl;
